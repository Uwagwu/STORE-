...
class StaffController {
    ...
    def save(Staff staffInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'staffInstance.label', default: 'Staff'), staffInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'staffInstance.label', default: 'Staff'), params.id])
                redirect action: "index", method: "GET"
            }
