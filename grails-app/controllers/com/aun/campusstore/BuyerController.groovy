...
class BuyerController {
    ...
    def save(Buyer buyerInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'buyerInstance.label', default: 'Buyer'), buyerInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'buyerInstance.label', default: 'Buyer'), params.id])
                redirect action: "index", method: "GET"
            }
